classdef Filter_Deconvolve_Disk < AbstractFilter
    %FILTER_Filter_Deconvolve_Gaussian - Deconvolve Gaussian PSF
    
    properties
        Name = 'Deconvolve Disk PSF';
    end
    
    methods
        function obj = Filter_Deconvolve_Disk()
            % Create dropdown:
        ...
        function img_out = process(obj,img_in,settingValues)
            ...
            disk_radius = settingValues('Disk Radius');
            
            kernel = fspecial('disk',disk_radius);
