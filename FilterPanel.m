classdef FilterPanel < matlab.ui.componentcontainer.ComponentContainer
    ...
    properties(Access = private)
        filterList = {  Filter_Nothing,...
                        ...
                        Filter_NoiseReducingFilter,...
                        Filter_PepperNoise,...
                        Filter_SaltNoise,...
                        Filter_SaltAndPeperNoise,...
                        Filter_GaussianNoise,...
                        Filter_Adaptive_Histogram_Exponential,...
                        Filter_Adaptive_Histogram_Rayleigh,...
                        Filter_Adaptive_Histogram_Uniform,...
                        Filter_Affine_Transformation,...
                        Filter_Radon_Reconstruction,...
                        Filter_Inverse_Radon_Reconstruction};
