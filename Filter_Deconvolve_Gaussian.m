classdef Filter_Deconvolve_Gaussian < AbstractFilter
    %FILTER_Filter_Deconvolve_Gaussian - Deconvolve Gaussian PSF
    
    properties
        Name = 'Deconvolve Gaussian PSF';
    end
    
    methods
        function obj = Filter_Deconvolve_Gaussian()
            % Create dropdown:
            ...
            fourthSettingName = 'Kernel Width';
            fourthSettingDefault = 30; % Number of iterations
            ...
            fifthSettingName = 'Kernel Sigma';
            fifthSettingDefault = 2; % Number of iterations
            fifthSettingBounds = [0,6];
            fifthSettingForceInteger = false; 
            fifthSettingInclusivity = [false, true]; 
        ...
        function img_out = process(obj,img_in,settingValues)
            ...
            kernel_width = settingValues('Kernel Width');
            kernel_sigma = settingValues('Kernel Sigma');
            
            kernel = fspecial('gaussian',kernel_width,kernel_sigma);
